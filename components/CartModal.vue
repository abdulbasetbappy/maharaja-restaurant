    ...
    <div class="modal-body">
          ...
          >
            <div class="row d-flex align-items-center" v-if="opt.max != 0">
              ...
              <div class="col-3">
                ...
                <h6 class="fw-bold text-end mb-0" v-else>
                  +{{ $currency }}{{ item.price }}
                </h6>
              </div>
            </div>
            ...
            >
              ...
              <div class="col-3">
                <h6 class="fw-bold text-end mb-0" v-if="opt.full_price">
                  {{ $currency
                  }}{{
                    parseFloat(item.price) +
      ...
      <div class="modal-footer">
        <div class="footer-buttons">
          <button class="btn close-button" @click="$emit('cancel', close)">
            <font-awesome-icon class="text-white" icon="close" size="2x" />
          </button>
          <button class="btn cart-button" @click="addToCart(close)">
            {{ $t("Add to Cart") }}
          </button>
        </div>
      </div>
